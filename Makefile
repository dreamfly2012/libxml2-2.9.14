...
ACLOCAL = ${SHELL} /f/code/c/gametank/mingw环境库文件/libxml2-2.9.14/libxml2-2.9.14/missing aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = ar
AUTOCONF = ${SHELL} /f/code/c/gametank/mingw环境库文件/libxml2-2.9.14/libxml2-2.9.14/missing autoconf
AUTOHEADER = ${SHELL} /f/code/c/gametank/mingw环境库文件/libxml2-2.9.14/libxml2-2.9.14/missing autoheader
AUTOMAKE = ${SHELL} /f/code/c/gametank/mingw环境库文件/libxml2-2.9.14/libxml2-2.9.14/missing automake-1.16
AWK = gawk
BASE_THREAD_LIBS = 
C14N_OBJ = c14n.c
...
LIBXML_VERSION_INFO = 11:14:9
LIBXML_VERSION_NUMBER = 20914
LIPO = 
LN_S = ln
LTLIBOBJS = 
LT_SYS_LIBRARY_PATH = 
...
LZMA_LIBS = 
MAINT = 
MAKEINFO = ${SHELL} /f/code/c/gametank/mingw环境库文件/libxml2-2.9.14/libxml2-2.9.14/missing makeinfo
MANIFEST_TOOL = :
...
PACKAGE_STRING = libxml2 2.9.14
PACKAGE_TARNAME = libxml2
PACKAGE_URL = 
PACKAGE_VERSION = 2.9.14
PATH_SEPARATOR = :
PERL = /usr/bin/perl
PKG_CONFIG = 
PKG_CONFIG_LIBDIR = 
PKG_CONFIG_PATH = /mingw64/lib/pkgconfig:/mingw64/share/pkgconfig
PYTHON = /c/Users/fujia/AppData/Local/Programs/Python/Python310/python
PYTHON_INCLUDES = C:\Users\fujia\AppData\Local\Programs\Python\Python310\include
PYTHON_LIBS = 
PYTHON_SITE_PACKAGES = ${exec_prefix}\Lib\site-packages
...
TEST_XPTR = XPtrtests
THREAD_CFLAGS =  -DHAVE_WIN32_THREADS -D_REENTRANT
THREAD_LIBS = 
VERSION = 2.9.14
...
WIN32_EXTRA_PYTHON_LIBADD = -L$(PYTHON_SITE_PACKAGES)/../../libs -lpython310
WITH_C14N = 1
WITH_CATALOG = 1
WITH_DEBUG = 1
WITH_DOCB = 1
...
XML_PRIVATE_LIBS = -lz    -liconv   
XPATH_OBJ = xpath.o
XPTR_OBJ = xpointer.o
XSLTPROC = /usr/bin/xsltproc
Z_CFLAGS = 
Z_LIBS = -lz
abs_builddir = /f/code/c/gametank/mingw环境库文件/libxml2-2.9.14/libxml2-2.9.14
abs_srcdir = /f/code/c/gametank/mingw环境库文件/libxml2-2.9.14/libxml2-2.9.14
abs_top_builddir = /f/code/c/gametank/mingw环境库文件/libxml2-2.9.14/libxml2-2.9.14
abs_top_srcdir = /f/code/c/gametank/mingw环境库文件/libxml2-2.9.14/libxml2-2.9.14
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = #
...
install_sh = ${SHELL} /f/code/c/gametank/mingw环境库文件/libxml2-2.9.14/libxml2-2.9.14/install-sh
...
# ./$(DEPDIR)/DOCBparser.Plo # am--include-marker
# ./$(DEPDIR)/HTMLparser.Plo # am--include-marker
# ./$(DEPDIR)/HTMLtree.Plo # am--include-marker
# ./$(DEPDIR)/SAX.Plo # am--include-marker
# ./$(DEPDIR)/SAX2.Plo # am--include-marker
# ./$(DEPDIR)/buf.Plo # am--include-marker
# ./$(DEPDIR)/c14n.Plo # am--include-marker
# ./$(DEPDIR)/catalog.Plo # am--include-marker
# ./$(DEPDIR)/chvalid.Plo # am--include-marker
# ./$(DEPDIR)/debugXML.Plo # am--include-marker
# ./$(DEPDIR)/dict.Plo # am--include-marker
# ./$(DEPDIR)/encoding.Plo # am--include-marker
# ./$(DEPDIR)/entities.Plo # am--include-marker
# ./$(DEPDIR)/error.Plo # am--include-marker
# ./$(DEPDIR)/globals.Plo # am--include-marker
# ./$(DEPDIR)/hash.Plo # am--include-marker
# ./$(DEPDIR)/legacy.Plo # am--include-marker
# ./$(DEPDIR)/list.Plo # am--include-marker
# ./$(DEPDIR)/nanoftp.Plo # am--include-marker
# ./$(DEPDIR)/nanohttp.Plo # am--include-marker
# ./$(DEPDIR)/parser.Plo # am--include-marker
# ./$(DEPDIR)/parserInternals.Plo # am--include-marker
# ./$(DEPDIR)/pattern.Plo # am--include-marker
# ./$(DEPDIR)/relaxng.Plo # am--include-marker
# ./$(DEPDIR)/runsuite.Po # am--include-marker
# ./$(DEPDIR)/runtest.Po # am--include-marker
# ./$(DEPDIR)/runxmlconf.Po # am--include-marker
# ./$(DEPDIR)/schematron.Plo # am--include-marker
# ./$(DEPDIR)/testAutomata.Po # am--include-marker
# ./$(DEPDIR)/testC14N.Po # am--include-marker
# ./$(DEPDIR)/testHTML.Po # am--include-marker
# ./$(DEPDIR)/testModule.Po # am--include-marker
# ./$(DEPDIR)/testReader.Po # am--include-marker
# ./$(DEPDIR)/testRegexp.Po # am--include-marker
# ./$(DEPDIR)/testRelax.Po # am--include-marker
# ./$(DEPDIR)/testSAX.Po # am--include-marker
# ./$(DEPDIR)/testSchemas.Po # am--include-marker
# ./$(DEPDIR)/testThreads.Po # am--include-marker
# ./$(DEPDIR)/testURI.Po # am--include-marker
# ./$(DEPDIR)/testXPath.Po # am--include-marker
# ./$(DEPDIR)/testapi.Po # am--include-marker
# ./$(DEPDIR)/testchar.Po # am--include-marker
# ./$(DEPDIR)/testdict.Po # am--include-marker
# ./$(DEPDIR)/testdso.Plo # am--include-marker
# ./$(DEPDIR)/testlimits.Po # am--include-marker
# ./$(DEPDIR)/testrecurse.Po # am--include-marker
# ./$(DEPDIR)/threads.Plo # am--include-marker
# ./$(DEPDIR)/tree.Plo # am--include-marker
# ./$(DEPDIR)/trio.Plo # am--include-marker
# ./$(DEPDIR)/triostr.Plo # am--include-marker
# ./$(DEPDIR)/uri.Plo # am--include-marker
# ./$(DEPDIR)/valid.Plo # am--include-marker
# ./$(DEPDIR)/xinclude.Plo # am--include-marker
# ./$(DEPDIR)/xlink.Plo # am--include-marker
# ./$(DEPDIR)/xmlIO.Plo # am--include-marker
# ./$(DEPDIR)/xmlcatalog.Po # am--include-marker
# ./$(DEPDIR)/xmllint.Po # am--include-marker
# ./$(DEPDIR)/xmlmemory.Plo # am--include-marker
# ./$(DEPDIR)/xmlmodule.Plo # am--include-marker
# ./$(DEPDIR)/xmlreader.Plo # am--include-marker
# ./$(DEPDIR)/xmlregexp.Plo # am--include-marker
# ./$(DEPDIR)/xmlsave.Plo # am--include-marker
# ./$(DEPDIR)/xmlschemas.Plo # am--include-marker
# ./$(DEPDIR)/xmlschemastypes.Plo # am--include-marker
# ./$(DEPDIR)/xmlstring.Plo # am--include-marker
# ./$(DEPDIR)/xmlunicode.Plo # am--include-marker
# ./$(DEPDIR)/xmlwriter.Plo # am--include-marker
# ./$(DEPDIR)/xpath.Plo # am--include-marker
# ./$(DEPDIR)/xpointer.Plo # am--include-marker
# ./$(DEPDIR)/xzlib.Plo # am--include-marker
